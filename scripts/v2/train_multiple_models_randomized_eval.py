...
Requires a GPU for reasonable training time, especially for ResNet18.  For reproducibility, a random seed controls the train/val/test split and all stochastic operations.
